...
// 将1张图片和1个MP3音频文件转为MP4
ffmpeg -i akane.aac -i cover.jpg -acodec aac -strict -2 -vcodec libx264 -ar 22050 -ab 128k -ac 2 -pix_fmt yuvj420p -y test.mp4
ffmpeg -i Rubia.mp3 -i cover.jpg -acodec mp3 -strict -2 -vcodec libx264 -ar 22050 -ab 128k -ac 2 -pix_fmt yuvj420p -y test.mp4

// 转为mp4
ffmpeg -i aaa.flv -c copy out.mp4
